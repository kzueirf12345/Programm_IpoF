...
print("Введите расположение файла координат атомов моделируемой области:")
fcube = open("build/crystal.txt")#'build/model.txt'
# print("Введите расположение файла координат атомов переодических граничных условий:")
# fpgu = open('build/pgu.txt')
xarr_cube, yarr_cube, zarr_cube = [], [], []
# xarr_pgu, yarr_pgu, zarr_pgu = [],[],[]
